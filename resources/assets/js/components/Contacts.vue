  ...
  <div>
    ...
    <form action="#" @submit.prevent="edit ? updateContact(contact.id) : createContact()">
      <div class="form-group">
        <input v-model="contact.name" type="text" name="name" placeholder="Your name" class="form-control">
      </div>
      <div class="form-group">
        <input v-model="contact.email" type="text" name="email" placeholder="Your email id." class="form-control">
      </div>
      <div class="form-group">
        <input v-model="contact.phone" type="text" name="phone" placeholder="Your phone no." class="form-control">
      </div>
      <div class="form-group">
